...
//		attributes = getAttributes();
		setAttribute("txtValue", "20");
		setAttribute(ATTR_INTENSITY, 20);
	}
	...
	)
	{
		...
		depth = Integer.parseInt(getAttribute(ATTR_INTENSITY, attributesIn).toString());
	...
	public MarvinAttributesPanel getAttributesPanel(){ 
		if(attributesPanel == null){
			...
			attributesPanel.addHorizontalSlider("hsIntensidade", "hsIntensidade", 0, 100, 20, getAttributes());
			attributesPanel.newComponentRow();
			attributesPanel.addTextField("txtValue", "txtValue",getAttributes());
