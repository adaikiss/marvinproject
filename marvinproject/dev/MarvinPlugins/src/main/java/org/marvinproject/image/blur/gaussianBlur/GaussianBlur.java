 ...
 * @author Gabriel Ambrosio Archanjo, Martin Mih�lyi
...
//		kernelMatrix = getGaussianKernel();
	...
	public MarvinAttributesPanel getAttributesPanel(){
		if(attributesPanel == null){
            ...
            attributesPanel.addTextField("txtRadius", ATTR_RADIUS, getAttributes());
		}
	...
	)
	{
		...
		int radius;
		radius = (Integer)getAttribute(ATTR_RADIUS, attributesIn);
		...
		int l_pixelColor;
		kernelMatrix = getGaussianKernel(radius);
...
//                    imageOut.setIntColor(x, y, imageIn.getAlphaComponent(x, y), imageIn.getIntColor(x, y));
				...
				applyKernel(x,y,l_pixelColor,imageOut, radius, resultMatrix, appiledkernelMatrix, kernelMatrix);
			}
...
//                    imageOut.setIntColor(x, y, imageIn.getAlphaComponent(x, y), imageIn.getIntColor(x, y));
	 ...
	 */
	private double[][] getGaussianKernel(int radius){
	 ...
	 */
	private void applyKernel(int centerPixel_X, int centerPixel_Y, int pixelColor, MarvinImage image, int radius, double[][][] resultMatrix, double[][] appiledkernelMatrix, double[][] kernelMatrix)
	{
